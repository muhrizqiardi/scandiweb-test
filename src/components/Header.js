          ...
          <div className="actions">
            ...
            >
              ...
              <svg
                ...
                className={`${
                  this.state.currencyPopupIsOpen ? "currency-popup-is-open" : ""
                }`}
              >
                <path
            ...
            >
              {this.state.currencyPopupIsOpen && (
                <div className="currency-popup">
                  <div
                    className={`currency-popup-item ${this.props.currency === "USD" ? "selected" : ""}`}
                    onClick={() => {
                  ...
                  <div
                    className={`currency-popup-item ${this.props.currency === "GBP" ? "selected" : ""}`}
                    onClick={() => {
                  ...
                  <div
                    className={`currency-popup-item ${this.props.currency === "AUD" ? "selected" : ""}`}
                    onClick={() => {
                  ...
                  <div
                    className={`currency-popup-item ${this.props.currency === "JPY" ? "selected" : ""}`}
                    onClick={() => {
                  ...
                  <div
                    className={`currency-popup-item ${this.props.currency === "RUB" ? "selected" : ""}`}
                    onClick={() => {
